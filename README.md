...
<table style="font-size: 14pt;">
   ...
   <tr><td>Enhancement and support for this version (<strong>release/8.6</strong>)
      of the Web Components SDK has ended with the release of Pega Infinity 8.8 in
      October 2022.
...
> **NOTE**: These setup tips are abstracted from the Web Components SDK Guide that is available at https://community.pega.com/knowledgebase/documents/web-components-sdk-user-guide. For more information about troubleshooting, see [Troubleshooting the DX SDKs](https://docs.pega.com/dx-sdks/troubleshooting-dx-sdks).
...
For the **APIHeadersAllowed** CORS record, confirm of update the record as follows:
