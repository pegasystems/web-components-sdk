...
test.describe('E2E test', () => {
  test('should login, create case and run different test cases for Case Reference', async ({
    ...
    await page.selectOption(
        'lion-select[datatestid="c2adefb64c594c6b634b3be9a40f6c83"] select',
        "Field"
    );

    /** Dropdown-Local field type tests */
    await page.selectOption(
        'lion-select[datatestid="3e9562266329f358c8fad0ce1094def9"] select',
        "Dropdown-Local"
    );

    await page.selectOption(
        'lion-select[datatestid="83b6f3f7c774ee2157bfd81b548b07bf"] select',
        "Coffee"
    );
    ...
    await page.selectOption(
        'lion-select[datatestid="311f2f128456b3bf37c7568da9ac1898"] select',
        "Dropdown"
    );
