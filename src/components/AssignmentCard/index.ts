  ...
  assignmentKids(): any {
    ...
    for (let kid of this.arChildren) {
      ...
      switch (kid.getPConnect().getComponentName()) {
        case "View":
          arKidHtml.push(
            html`<view-component .pConn=${kidPConn}></view-component>`,
          );
          break;
        ...
        case "CaseCreateStage":
          arKidHtml.push(
            html`<case-create-stage-component
              .pConn=${kidPConn}
            ></case-create-stage-component>`,
          );
          break;

        case "Region":
          arKidHtml.push(
            html`<region-component .pConn=${kidPConn}></region-component>`,
          );
          break;

        default:
          console.error(
            `${this.theComponentName} trying to render unknown child type: ${kid.getPConnect().getComponentName()}`,
          );
          break;
      }
    }
