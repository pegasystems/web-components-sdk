        ...
        ${this.item.primary.type == 'URL'
          ? html` <div class="psdk-utility-card-main-primary-url">
              <lion-button @click="item.primary.click">
                ...
                <img class="psdk-utility-card-actions-svg-icon" src="${this.imagePath}${this.item.primary.icon}.svg" />
              </lion-button>
            </div>`
          : html` <div class="psdk-utility-card-main-primary-label">${this.item.primary.name}</div> `}
      ...
      <div class="psdk-utility-card-actions">
        ${this.menuIconOverride == ''
          ? html` <div class="psdk-utility-menu">
              ...
              <div id="actionMenu" class="psdk-action-menu-content">${this.getActionButtonMenuHtml(this.item.actions)}</div>
            </div>`
          : html`
              <lion-button @click="${this._actionClick}">
                <img class="psdk-utility-card-actions-svg-icon" src="${this.menuIconOverride}" />
              </lion-button>
            `}
      </div>
    </div>`;
