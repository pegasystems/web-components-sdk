...
class TextArea extends FormComponentBase {
  ...
  connectedCallback() {
    ...
    this.theComponentStyleTemplate = textAreaStyles;
    ...
    const theContent = html`${ this.bVisible ?
      ...
      <div class="form-group">
        <lion-textarea 
          ...
          rows=5 ?readonly=${this.bReadonly} 
          ?disabled=${this.bDisabled} @click=${this.fieldOnChange} @blur=${this.fieldOnBlur} @change=${this.fieldOnChange}>
