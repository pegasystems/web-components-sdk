...
*/
  ...
  connectedCallback() {
    ...
    this.navIcon = Utils.getIconPath(Utils.getSDKStaticContentUrl()).concat(
      "pzpega-logo-mark.svg",
    );
    this.navExpandCollapse = Utils.getImageSrc(
      "plus",
    ...
    for (let page in this.navPages) {
      ...
      this.navPages[page]["iconName"] = Utils.getImageSrc(
    ...
    // was "assets" in Angular SDK ; is "static" in React
    this.portalLogoImage = Utils.getIconPath(
      Utils.getSDKStaticContentUrl(),
  ...
  render() {
    ...
    const theOperatorButtons = html`
      <button
        ...
        @click=${this.navPanelLogoutClick}
      >
        Logoff
      </button>
    `;
        ...
        <div>
          <ul class="psdk-nav-ul-middle">
            <li class="psdk-nav-li-middle">
              ...
              >
                <img
                  class="psdk-nav-svg-icon"
                  src="${this.navExpandCollapse}"
                />
        ...
        <div class="psdk-appshell-bottom">
          <ul class="psdk-nav-ul-middle">
            <li class="psdk-nav-li-middle">
              ...
              >
                <div class="psdk-nav-oper-avatar">
                  ${this.portalOperatorInitials}
                </div>
                <span class="psdk-nav-button-span">${this.portalOperator}</span>
              </button>
              <br />
              ${this.bShowOperatorButtons
                ? html`<div style="padding-left: 0rem;">
                    ${theOperatorButtons}
                  </div>`
                : nothing}
            </li>
