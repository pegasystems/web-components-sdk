...
class MashupUplusUconnect extends LitElement {
  static styles?: CSSResultGroup = mashupUplusUconnectStyles;
        ...
        <div style="display: flex; flex-direction: column;gap: 2rem;">
          <div style="display: flex; gap:2rem">
            <div class="card-team" style="width:49%">
              <div class="heading">Service Team</div>
              <table>
                <tr>
                  <td style="width: 20%">
            ...
            <div class="card-team" style="width:49%">
              <div class="heading">Driver Profiles</div>
              <table>
                <tr>
                  <td style="width: 20%">
          ...
          <div class="card-team">
            <div class="heading">Your service history</div>
            <table>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p style="font-size:small; color:gray; margin-bottom: auto;">
                    Replaced from left rotor and brake pads, windshield wipers, and investigated rattle near driver's side window
                  </p>
                </td>
                <td>
                  <img src="./assets/img/table-arrow_right_24px.png" />
  ...
  _schedule() {
    const event = new CustomEvent('ScheduleService', {});
