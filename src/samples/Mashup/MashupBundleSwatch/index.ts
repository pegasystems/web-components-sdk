...
class MashupBundleSwatch extends LitElement {
  ...
  connectedCallback() {
    ...
    this.labelDollars = this.swatchConfig.price.substring(
      0,
      this.swatchConfig.price.indexOf("."),
    );
    this.labelCents =
      this.swatchConfig.price.substring(
        this.swatchConfig.price.indexOf(".") + 1,
      ) + "/month";
      ...
      <div>
        ...
        <div class="cc-swatch-body">
          ...
          <ul>
            ...
            <li>
              Watch on the ${PCore.getEnvironmentInfo().getApplicationLabel()}
              App
            </li>
