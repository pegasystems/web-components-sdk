...
//  BUT.... we need to make one change to the bootstrap.min.css file to
//    escape the backslashes in the .blockquote-footer::before CSS class definition
//    The reasoning is described here:
//      https://github.com/Polymer/lit-element/issues/637 - that explains why we need to edit this to escape the single slash
